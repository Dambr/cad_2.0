function powerChange(){
	document.getElementById("powerValue").textContent = Math.round(Number(document.getElementById("changeMinPower").value) + Number(document.getElementById("power").value) * (Number(document.getElementById("changeMaxPower").value) - Number(document.getElementById("changeMinPower").value))) + document.getElementById("selectMeasure").options[document.getElementById("selectMeasure").options.selectedIndex].textContent;
}
...
function measureChange(){
	...
	document.getElementById("powerValue").textContent = Math.round(Number(document.getElementById("changeMinPower").value) + Number(document.getElementById("power").value) * (Number(document.getElementById("changeMaxPower").value) - Number(document.getElementById("changeMinPower").value))) + measure;
};
measureChange();